...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE users SET Nama_Perusahaan='$Nama Perusahaan',Email_Perusahaan='$Email Perusahaan',$Alamat_Perusahaan='$Alamat_Perusahaan' WHERE ID_Perusahaan=$'$ID Perusahaan'");
